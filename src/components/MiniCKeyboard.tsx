...
const MiniCKeyboard: React.FC = () => {
    return (
        ...
        md:w-[740px] lg:w-[1000px] xl:w-[1240px] 2xl:w-[1500px] flex flex-col m-6 lg:flex-row'>
            ...
            <div className="m-2 items-center justify-center flex flex-col 2xl:ml-5">
                ...
                <div className="lg:mt-auto flex justify-center items-center">
