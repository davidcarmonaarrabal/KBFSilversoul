    ...
    return (
        ...
        shadow-[5px_5px_0px_rgba(0,0,0,0.1)]">
            ...
            <div className="pt-4 flex flex-col mb-4">
                <h1 className="text-2xl xl:text-4xl">Real Madrid Keyboard 75%</h1>
                <p className="text-left xl:text-2xl mt-6">If you are a Soccer lover, you will also love this Keyboard. Not fully modded, but for me, an excellent option.
                </p>
                ...
                <p className="text-left xl:text-2xl mt-6">In this case, this Keyboard uses linear switches, specifically KANG White V3</p>
                <Switch switchId={3}></Switch>
