    ...
    return (
        ...
        shadow-[5px_5px_0px_rgba(0,0,0,0.1)]">
            ...
            <div className="pt-4 flex flex-col mb-4">
                <h1 className="text-2xl xl:text-4xl">Zelda Keyboard 65%</h1>
                <p className="text-left xl:text-2xl mt-6">The perfect keyboard for an Legend Of Zelda enthusiast, compact, beautiful and simple.
                </p>
