    ...
    return (
        ...
        shadow-[5px_5px_0px_rgba(0,0,0,0.1)]">
            ...
            <div className="pt-4 flex flex-col mb-4">
                <h1 className="text-2xl xl:text-4xl">JoJo&apos;s Bizarre Adventure Keyboard 75%</h1>
                <p className="text-left xl:text-2xl mt-6">With this keyboard you will surely unlock your Stand.
                </p>
                ...
                <p className="text-left xl:text-2xl mt-6">In this case, this Keyboard uses tactile switches, specifically OUTEMU Gray Silent</p>
                <Switch switchId={10}></Switch>
                ...
                more oriented to coding, and a new set of keycaps.
                </p>
